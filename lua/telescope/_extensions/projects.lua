...
local function projects(opts)
  ...
  pickers.new(opts, {
    ...
    attach_mappings = function(prompt_bufnr, map)
      map("n", config.options.mappings.n.find_project_files, find_project_files)
      map("n", config.options.mappings.n.browse_project_files, browse_project_files)
      map("n", config.options.mappings.n.delete_project, delete_project)
      map("n", config.options.mappings.n.search_in_project_files, search_in_project_files)
      map("n", config.options.mappings.n.recent_project_files, recent_project_files)
      map("n", config.options.mappings.n.change_working_directory, change_working_directory)

      map("i", config.options.mappings.i.find_project_files, find_project_files)
      map("i", config.options.mappings.i.browse_project_files, browse_project_files)
      map("i", config.options.mappings.i.delete_project, delete_project)
      map("i", config.options.mappings.i.search_in_project_files, search_in_project_files)
      map("i", config.options.mappings.i.recent_project_files, recent_project_files)
      map("i", config.options.mappings.i.change_working_directory, change_working_directory)
